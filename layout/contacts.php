    ...
    $( document ).ready(function() { 
      ...
      function init(){     
        myMap = new ymaps.Map("yamap", {
            center: [53.97184728, 27.54127750],
            zoom: 16
        });
        myPlacemark = new ymaps.Placemark([53.97184728, 27.54127750], { 
          hintContent: 'ООО "Руфсистемс"'   
        }, {
  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Контакты</span>
      </div>
      <h1>Контакты</h1>
      <div class="contacts">
        <div class="contacts_title">ООО "Руфсистемс"</div>
        <div class="contacts_wrap">
          <div class="contacts_item contacts_item__phone">
            <div class="contacts_head">Телефон</div>
            <p>(017)289-06-54</p>
            <p>(029)626-78-95</p>
            <p>(029)629-74-29</p>
          </div>
          <div class="contacts_item contacts_item__address">
            <div class="contacts_head">Адрес</div>
            <p>г.Минск, д. Чижовка,</p>
            <p>ул. Кольцевая 2, </p>
            <p>офис 21A</p>
          </div>
          <div class="contacts_item contacts_item__email">
            <div class="contacts_head">E-mail</div>
            <a href="#">sales@ruf.by</a>
          </div>
        </div>
        <div id="yamap" class="contacts_map"></div>
        <div class="feedback">
            ...
            <form action="">
              ...
              <div class="feedback_inner">
                ...
                <div class="form-textarea-wrapper">
                  <textarea id="edit-submitted-message" class="form-textarea required" rows="5" cols="60" name="submitted[message]"></textarea>
                </div>
              </div>
              <div class="feedback_button">
                <input id="edit-webform-ajax-submit-12" class="webform-submit button-primary form-submit ajax-processed" type="submit" value="Отправить" name="op">
              </div>
            </form>
          </div>
          <div class="feedback_item feedback_item__callback">
            <div class="feedback_title feedback_title__callback">Заказать звонок</div>
            <form action="">
              <div class="feedback_inner">
                <div class="feedback_label">Ваше имя:</div>
                <input type="text">
              ...
              <div class="feedback_button feedback_button__callback">
                <input id="edit-webform-ajax-submit-12" class="webform-submit button-primary form-submit ajax-processed" type="submit" value="Заказать" name="op">
              </div>
            </form>
          </div>
        </div>
