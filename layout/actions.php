  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Акции</span>
      </div>
      <h1>Акции</h1>
      <div class="actions">
        <div class="actions_item">
          <div class="actions_image"><img src="image/action1.jpg" alt=""></div>
          <div class="actions_text">
            <div class="actions_title">Закажите черепицу и получите скидку на окно и водосток 15%!</div>
            <div class="actions_date">до 12.06.2015</div>
            <div class="actions_descr">Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения</div>
            <a href="action.php" class="actions_link">Читать подробнее</a>
          </div>
        </div>
        <div class="actions_item">
          <div class="actions_image"><img src="image/action2.jpg" alt=""></div>
          <div class="actions_text">
            <div class="actions_title">Новинка - IKO Skyline 7,99 евро/м2 до 1 июня!</div>
            <div class="actions_date">до 24.06.2015</div>
            <div class="actions_descr">Наши специалисты ежегодно проходят обучение. Мы сотрудничаем с крупнейшими производителями строительных материалов в РБ.</div>
            <a href="action.php" class="actions_link">Читать подробнее</a>
          </div>
        </div>
        <div class="actions_item">
          <div class="actions_image"><img src="image/action3.jpg" alt=""></div>
          <div class="actions_text">
            <div class="actions_title">Модульная металлочерепица VENECJA! 123 000 руб панель</div>
            <div class="actions_date">до 29.07.2015</div>
            <div class="actions_descr">Мы сделали ставку на достаточно узкую специализацию, что в сочетании с высоким профессионализмом сотрудников позволило нам занять достойное место</div>
            <a href="action.php" class="actions_link">Читать подробнее</a>
          </div>
        </div>
      </div>
