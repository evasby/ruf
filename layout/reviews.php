  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Отзывы</span>
      </div>
      <h1>Отзывы</h1>
      <div class="reviews">
        <div class="reviews_item">
          <div class="reviews_text">Металлочерепица сейчас один из самых практичных и доступных способов перекрыть крышу. Шифер давно вышел из моды и это не красиво. Обычная черепица - относительно дорогое удовольствие. Egor - то что у вас металлочерепица держится уже 12 лет - это заслуга не только производителя, но и мастеров, устанавливавших ее. Ведь одна незначительная царапина краски на металле и все - через несколько лет ржавеет.</div>
          <div class="reviews_wrap">
            <div class="reviews_image">
              <img src="image/review1.jpg" alt="">
              <div class="reviews_name">Крышкин И.В.</div>
              <div class="reviews_job">Директор ОАО «QTE»</div>
            </div>
            <a href="#" class="reviews_link">Смотреть фото объекта</a>
          </div>
        </div>
        <div class="reviews_item">
          <div class="reviews_text">У меня металлочерепица держится уже 12 лет и никаких намеков на ржавчину или протечку даже нет. Покупал материал пластизол, он конечно был дороже полиэстера, зато теперь спокоен что еще 20 лет ничего ремонтировать не придется.</div>
          <div class="reviews_wrap">
            <div class="reviews_image">
              <img src="image/review2.jpg" alt="">
              <div class="reviews_name">Иванов А.К.</div>
              <div class="reviews_job">Менеджер ОАО «Агранд»</div>
            </div>
            <a href="#" class="reviews_link">Смотреть фото объекта</a>
          </div>
        </div>
        <div class="reviews_item">
          <div class="reviews_text">Я на даче у себя год назад положил металлочерепицу . Все нормально до сих пор никаких проблем и протеков. Только главное в этом деле доверять тем людям, которые строят и прислушиваться к советам, так крепежные болты лучше вкручивать на гребне, это же не шифер. Да и сама обрешетка должна быть хорошо высушена, что бы крышу "не повело" и не образовались бреши. А вообще доволен - эстетично и надежно.</div>
          <div class="reviews_wrap">
            <div class="reviews_image">
              <img src="image/review3.jpg" alt="">
              <div class="reviews_name">Семенов Б.В.</div>
              <div class="reviews_job">Директор ОАО «Домовой»</div>
            </div>
            <a href="#" class="reviews_link">Смотреть фото объекта</a>
          </div>
        </div>
