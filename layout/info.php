  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Полезная информация</span>
      </div>
      <h1>Полезная информация</h1>
      <div class="info">
        <div class="info_item">
          <div class="info_image"><img src="image/info1.jpg" alt=""></div>
          <div class="info_text">
            <div class="info_title">Чердачная скатная крыша - устройство и конструкция</div>
            <div class="info_descr">Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения</div>
            <a href="infoitem.php" class="info_link">Читать подробнее</a>
          </div>
        </div>
        <div class="info_item">
          <div class="info_image"><img src="image/info2.jpg" alt=""></div>
          <div class="info_text">
            <div class="info_title">По количеству и виду скатов крыши домов бывают</div>
            <div class="info_descr">Наши специалисты ежегодно проходят обучение. Мы сотрудничаем с крупнейшими производителями строительных материалов в РБ.</div>
            <a href="infoitem.php" class="info_link">Читать подробнее</a>
          </div>
        </div>
        <div class="info_item">
          <div class="info_image"><img src="image/info3.jpg" alt=""></div>
          <div class="info_text">
            <div class="info_title">Конструкции чердачных скатных крыш домов</div>
            <div class="info_descr">Мы сделали ставку на достаточно узкую специализацию, что в сочетании с высоким профессионализмом сотрудников позволило нам занять достойное место</div>
            <a href="infoitem.php" class="info_link">Читать подробнее</a>
          </div>
        </div>
      </div>
