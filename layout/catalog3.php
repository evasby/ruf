  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Металлочерепица</span>
      </div>
      <h1>Металлочерепица</h1>
      <div class="category">
        <div class="category_left">
          <div class="category_image">
            <img src="image/catalog3-1.jpg" alt="">
          </div>
          <a href="" class="category_calc">Расчет материалов</a>
          <a href="" class="category_price">Прайс лист</a>
        </div>
        <div class="category_text"><p>Производство Бельгия. Изготавливается из стали 0,35мм концерна Arcelor Mittal  с покрытием MAGNELIS ZM 300-сплав толщиной 300гр/м.кв. и ALUZINC 185. Верхний слой -кварцевый песок, покрытый акриловой глазурью. Применяется для кровель с углом от10-90гр. 9видов панели в различных цветовых решениях</p></div>
      </div>
      <div class="brands">
        <div class="brands_title">Производители</div>
        <div class="brands_item">
          <div class="brands_image">
            <img src="image/brand1.jpg" alt="">
          </div>
          <div class="brands_info">
            <div class="brands_head">Черепица Metrotile</div>
            <div class="brands_country">Германия</div>
            <div class="brands_text"><p>Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения</p></div>
            <a href="catalog2.php" class="brands_link">Посмотреть ассортимент</a>
          </div>
        </div>
        <div class="brands_item">
          <div class="brands_image">
          ...
          <div class="brands_info">
            <div class="brands_head">Черепица Gerard</div>
            <div class="brands_country">Германия</div>
            <div class="brands_text"><p>Наши специалисты ежегодно проходят обучение. Мы сотрудничаем с крупнейшими производителями строительных материалов в РБ.</p></div>
            <a href="catalog2.php" class="brands_link">Посмотреть ассортимент</a>
          </div>
        </div>
      </div>
