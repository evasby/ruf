  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <a class="breadcrumb_link" href="actions.php">Акции</a>
        <span class="breadcrumb_item">Черепица по скидке</span>
      </div>
      <h1>Черепица по скидке</h1>
      <div class="action">
        <div class="action_item">
          <div class="action_image">
            <img src="image/action1.jpg" alt="">
            <a href="#" class="action_link">Воспользоваться акцией</a>
          </div>
          <div class="action_text">
            <div class="action_title">Закажите черепицу и получите скидку на окно и водосток 15%!</div>
            <div class="action_date">до 12.06.2015</div>
            <div class="action_descr">Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения, которые экономят время и деньги наших клиентов. Предоставляет полный комплекс услуг, связанный с продажей кровельных и фасадных материалов. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения, которые экономят время и деньги наших клиентов.</div>
          </div>
        </div>
      </div>
      <div class="otheractions">
        <div class="otheractions_title">Другие предложения</div>
        <div class="otheractions_wrap">
          <a href="#" class="otheractions_item">
            <img src="image/otheraction1.jpg" alt="">
            Новинка - IKO Skyline 7,99 евро/м2 до 1 июня!
          </a>
          <a href="#" class="otheractions_item">
            <img src="image/otheraction2.jpg" alt="">
            Gerard DIAMANT 7,99 евро
          </a>
          <a href="#" class="otheractions_item">
            <img src="image/otheraction3.jpg" alt="">
            Модульная металлочерепица VENECJA! 123 000 руб панель
          </a>
        </div>
      </div>
    </div>
