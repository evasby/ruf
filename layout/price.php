  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">Прайс</span>
      </div>
      <h1>Прайс</h1>
      <div class="myprice">
        <div class="myprice_descr"><p>Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения, которые экономят время и деньги наших клиентов. На сегодняшний день наша компания предоставляет полный комплекс услуг, связанный с продажей кровельных и фасадных материалов, строительством кровли и монтажом навесных вентилируемых фасадов.</p></div>
        <a href="#" class="myprice_link">Цены в формате excel</a>
      </div>
      <div class="mytables">
        <div class="mytables_item">
          <div class="mytables_title">Кровельные материалы</div>
          <table>
          <thead><tr><th>Наименование</th><th>Производитель</tr></thead>
          <tbody>
          <tr><td>Металлочерепица</td><td>Adamante, Monterrey, Finnera, Монтеррей Pural МАТТ</td></tr>
          <tr><td>Гибкая черепица</td><td>Монтеррей Pural МАТТ, Finnera</td></tr>
          </tbody>
          </table>
        </div>
        <div class="mytables_item">
          <div class="mytables_title">Фасадные материалы</div>
          <table>
          <thead><tr><th>Наименование</th><th>Производитель</tr></thead>
          <tbody>
          <tr><td>Сайдинг виниловый</td><td>Monterrey, Adamante, Finnera, Монтеррей Pural МАТТ</td></tr>
          <tr><td>Виниловое бревно</td><td>Adamante,Монтеррей Pural МАТТ</td></tr>
          </tbody>
          </table>
        </div>
      </div>
