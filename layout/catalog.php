...
<body>
  ...
  <div class="content inner">
    <div class="breadcrumb">
      ...
      <span class="breadcrumb_item">Каталог</span>
    </div>
    <h1>Каталог</h1>
    <div class="catalog">
      <div class="catalog_descr"><p>Наша фирма выполняет качественно и в сжатые, удобные для заказчика сроки, кровельные работы  в Минске любой видовой сложности. Опытные мастера сделают вашу крышу надежной и прочной, под ней вам не будет страшна ни одна беда. В спектр наших услуг входит установка кровельных систем безопасности, монтаж любых кровельных покрытий (монтаж металлочерепицы, битумной черепицы,натуральной керамической и цементно-песчаной черепицы, композинтой черепицы, модульной металлочерепицы, мягкой наплавляемой кровли), установку мансардных окон, подшивка карнизов, монтаж детали водосточных систем. Нашими высококлассными специалистами проводятся кровельные работы в Минске и по территории всей РБ с использованием различных современных материалов и разнообразнейших конструкций, профилей из пластиков и металла, а также с применением мягких кровлей.</p></div>
      <div class="catalog_title">Наша продукция</div>
      <div class="catalog_wrap">
        <div class="catalog_row">
          <div class="catalog_item">
            <img src="image/catalog1.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Керамическая плитка</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд3</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд4</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд5</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд6</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд7</a></li>
            </ul>
          </div>
          <div class="catalog_item">
            <img src="image/catalog2.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Сланцевая кровля</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
            </ul>
          ...
          <div class="catalog_item">
            <img src="image/catalog3.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Цементно-песчаная черепица</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
            </ul>
          ...
          <div class="catalog_item">
            <img src="image/catalog4.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Гибкая черепица</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд3</a></li>
        ...
        <div class="catalog_row">
          <div class="catalog_item">
            <img src="image/catalog5.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Фальцевая кровля</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд3</a></li>
          ...
          <div class="catalog_item">
            <img src="image/catalog6.jpg" alt="">
            <a href="catalog3.php" class="catalog_link">Композитная черепица</a>
            <ul class="catalog_list">
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд1</a></li>
              <li class="catalog_listitem"><a href="catalog2.php" class="catalog_listlink">Бренд2</a></li>
            </ul>
