  ...
  <div class="content inner">
    ...
    <div class="rcontent">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb_item">О нас</span>
      </div>
      <h1>О нас</h1>
      <p>Наша компания работает в сфере строительства с 2009г. За годы работы и благодаря накопленному опыту мы стремимся использовать наиболее эффективные решения, которые экономят время и деньги наших клиентов. На сегодняшний день наша компания предоставляет полный комплекс услуг, связанный с продажей кровельных и фасадных материалов, строительством кровли и монтажом навесных вентилируемых фасадов. Мы сделали ставку  на достаточно узкую специализацию, что в сочетании с высоким профессионализмом сотрудников, позволило нам занять достойное место в своей нише строительного рынка."Руфсистемс" — гарантия качества, поэтому мы не стремимся объять необъятное.</p>
      <p>Наши специалисты ежегодно проходят обучение. Мы сотрудничаем с крупнейшими производителями строительных материалов в РБ. Мы постоянно отслеживаем новейшие разработки, как в области строительных материалов, так и технологии работ, и предлагаем только лучшее. Мы несем ответственность за свою работу и предоставляем гарантии. Компания «Руфсистемс»  имеет все необходимые разрешения и сертификаты.</p>
    </div>
  </div>
  <footer class="footer">
